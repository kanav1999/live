...
class _AudioWaveState extends State<AudioWave> {
  ...
  bars: [
  AudioWaveBar(heightFactor: .10, color: Colors.lightBlueAccent,),
  AudioWaveBar(heightFactor: .30, color: Colors.blue),
  AudioWaveBar(heightFactor: .70, color: Colors.black),
  AudioWaveBar(heightFactor: .40),
  AudioWaveBar(heightFactor: .100, color: Colors.orange),
  AudioWaveBar(heightFactor: .90, color: Colors.lightBlueAccent),
  AudioWaveBar(heightFactor: .80, color: Colors.blue),
  AudioWaveBar(heightFactor: .70, color: Colors.black),
  AudioWaveBar(heightFactor: .40),
  AudioWaveBar(heightFactor: .20, color: Colors.orange),
  AudioWaveBar(heightFactor: .10, color: Colors.lightBlueAccent),
  AudioWaveBar(heightFactor: .30, color: Colors.blue),
  AudioWaveBar(heightFactor: .70, color: Colors.black),
  AudioWaveBar(heightFactor: .40),
