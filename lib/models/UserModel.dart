...
import 'package:heyto/models/PaymentSourceModel.dart';
...
class UserModel extends ParseUser implements ParseCloneable {
  ...
  static final String keyAvatars = "avatars";
  ...
  static final String keyCredit = "credit";
  ...
  // Notifications
  static final String keyPushNotificationsMessage = "pushMessages";
  static final String keyPushNotificationsMatches = "pushMatches";
  static final String keyPushNotificationsLike = "pushLikedYou";
  static final String keyPushNotificationsVisitor = "pushProfileVisitor";
  static final String keyPushNotificationsFavorite = "pushFavoritedYou";
  static final String keyPushNotificationsLive = "pushLive";
  ...
  static final String keyStripeCustomerId = "stripe_customer_id";
  ...
  set addCredit(int credits) => setIncrement(keyCredit, credits);
  set removeCredit(int credits) => setDecrement(keyCredit, credits);
  ...
  set setFavoritesUser(UserModel userModel) {
    ...
    setAddAllUnique(keyFavorites, user);
  }

  set removeFavoriteUser(UserModel userModel) {
    List<String> user = [];
  ...
  set unsetRemovedMatch(UserModel userModel) {
    List<String> user = [];
    user.add(userModel.objectId!);
    setRemoveAll(keyRemovedMatch, user);
  }
