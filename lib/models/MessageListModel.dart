...
class MessageListModel extends ParseObject implements ParseCloneable {
  ...
  static final String keyOnline = "online";

  static final String keyFavorite = "favorite";
  ...
  bool? get isOnline {
    bool? online = get<bool>(keyOnline);
    if(online != null){
      return online;
    } else {
      return false;
  ...
  set setIsOnline(bool isOnline) => set<bool>(keyOnline, isOnline);

  bool? get isFavorite {
    bool? favorite = get<bool>(keyFavorite);
    if(favorite != null){
      return favorite;
    } else {
      return false;
  ...
  set setIsFavorite(bool isFavorite) => set<bool>(keyFavorite, isFavorite);
