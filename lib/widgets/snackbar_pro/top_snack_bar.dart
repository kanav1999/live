...
import 'package:heyto/widgets/snackbar_pro/tap_bounce_container.dart';
...
class _TopSnackBarState extends State<TopSnackBar>
  ...
  Widget build(BuildContext context) {
    return AnimatedAlign(
      ...
      alignment: Responsive.isWebOrDeskTop(context) ? Alignment.topRight : Alignment.topCenter,
      child: SlideTransition(
        position: offsetAnimation as Animation<Offset>,
        child: SafeArea(
          child: Padding(
            padding: EdgeInsets.only(top: topPosition!, left: widget.leftPadding, right: widget.rightPadding,),
