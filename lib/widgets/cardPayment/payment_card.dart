...
class CardUtils {
  static String? validateCVV(String? value) {
    if (value == null || value.isEmpty) {
      return "in_app_purchases.cvv_required".tr();
    }

    if (value.length < 3 || value.length > 4) {
      return "in_app_purchases.cvv_invalid".tr();
    }
    return null;
  }
  ...
  static String? validateDate(String? value) {
    if (value == null || value.isEmpty) {
      return "in_app_purchases.exp_required".tr();
    }
    ...
    if ((month < 1) || (month > 12)) {
      ...
      return "in_app_purchases.exp_month_inv".tr();
    }
    ...
    if ((fourDigitsYear < 1) || (fourDigitsYear > 2099)) {
      ...
      return "in_app_purchases.exp_year_inv".tr();
    }

    if (!hasDateExpired(month, year)) {
      return "in_app_purchases.card_number_expired".tr();
    }
    return null;
  }
  ...
  static String? validateCardNum(String? input) {
    if (input == null || input.isEmpty) {
      return "in_app_purchases.card_number_required".tr();
    }

    input = getCleanedNumber(input);

    if (input.length < 8) {
      return "in_app_purchases.card_number_invalid".tr();
    }
